...
public class SecurityServiceImpl implements SecurityService {
	...
	@Override
	public void autoLogin(String email, String password, List<Role> role, HttpServletRequest request) {
		if(StringUtils.hasText(password)) {
			...
			grantedAuthorities.add(new SimpleGrantedAuthority("ROLE_"+role.get(0).getRoleName()));
